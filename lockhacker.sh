#!/bin/bash
# LockHacker by HackElite
#youtube.com/HackElite
#not for illegel use
...
echo
trap 'printf "\n";stop;exit 1' 2
loc=/data/data/com.termux/files/home/lockhacker/setup
if [ -f "$loc" ]; then
cd $HOME/lockhacker
bash setup
fi
clear
check(){
if wget --spider https://raw.githubusercontent.com/hackelite01/lockhacker/master/update.v1.4 2>/dev/null; then
...
option
check1(){
if wget --spider https://raw.githubusercontent.com/hackelite01/patchupdate/main/lockhackerpatch.v.1 2>/dev/null; then
cd $HOME/lockhacker/core/update
...
am start -a android.intent.action.VIEW -d https://bit.ly/3cgYNjK > /dev/null 2>&1 
...
cd $HOME/lockhacker/core/about/
bash about.sh
elif [[ $option == 8 || $option == 08 ]]; then
am start -a android.intent.action.VIEW -d https://bit.ly/3z38fRK > /dev/null 2>&1 
elif [[ $option == 9 ]]; then
exit 1
else
...
printf "\e[1;92m   / /  ___   ___| | __ /\  /\__ _  ___| | _____ _ __ \e[0m\n"
printf "\e[1;92m  / /  / _ \ / __| |/ // /_/ / _` |/ __| |/ / _ \ '__|\e[0m\n"
printf "\e[1;92m / /__| (_) | (__|   </ __  / (_| | (__|   <  __/ |   \e[0m\n"
printf "\e[1;92m  \____/\___/ \___|_|\_\/ /_/ \__,_|\___|_|\_\___|_| V1.1 \e[0m\n"   
printf "\n"
printf "                  \e[104m\e[1;77m  >>  Script By HackElite << \e[0m\n"
printf "\n"
printf "           \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m HackElite \e[100m\e[1;77m << \e[0m\n"
printf "\n"
...
fixer(){
  ...
  printf "\e[1;92m WATCH THIS VIDEO t.me/hackelite01 \e[0m\n"
