...
echo
echo
echo -e "\e[92m          LOCKHACKER LATEST \e[91mNO PATCH AVAILABLE FOR NOW...!\e[92m\e[0m"
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
...
option(){
if [ -f "$HOME/lockhacker/core/update/patch.txt" ];then
$dbox
else
echo
fi
...
echo
echo
echo -e "\e[92m                LOCKHACKER LATEST PATCH V1 IS AVAILABLE\e[0m"
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
echo -e "\e[96m                ║  \e[93mLOCKHACKER\e[96m Patch Is avaialbe\e[93m V1.0\e[96m  ║\e[0m"
echo -e "\e[96m                ║    To PAtch The \e[93mLOCKHACKER\e[96m Tool     ║\e[0m"
echo -e "\e[96m                ║                                   ║\e[0m"
